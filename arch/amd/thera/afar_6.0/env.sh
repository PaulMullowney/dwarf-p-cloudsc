...
module load rocm-afar-drop/6.0.0
module load cmake/3.27.4

export HDF5_DIR=/PATH/TO/HDF5_ROCM_AFAR_DROP_6.0.0/
# Example
#export HDF5_DIR=/home/pmullown/ecmwf/install/hdf5/rocm-afar-6.0.0/
if [[ ! -d $HDF5_DIR ]]; then
    echo "You must set the HDF5 directory to one built with rocm-afar-drop/6.0.0"
