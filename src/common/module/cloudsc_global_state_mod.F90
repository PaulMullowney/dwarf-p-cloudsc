...
!$omp end parallel do 
  ...
  SUBROUTINE CLOUDSC_GLOBAL_STATE_VALIDATE(SELF, NPROMA, NGPTOT, NGPTOTG)
    ...
    CALL VALIDATE('TENDENCY_LOC%A', B_LOC(:,:,:,:), SELF%B_LOC(:,:,:,:), NPROMA, SELF%KLEV, NCLV, NGPTOT, NBLOCKS, NGPTOTG, 2)
    CALL VALIDATE('TENDENCY_LOC%Q', B_LOC(:,:,:,:), SELF%B_LOC(:,:,:,:), NPROMA, SELF%KLEV, NCLV, NGPTOT, NBLOCKS, NGPTOTG, 3)
    CALL VALIDATE('TENDENCY_LOC%T', B_LOC(:,:,:,:), SELF%B_LOC(:,:,:,:), NPROMA, SELF%KLEV, NCLV, NGPTOT, NBLOCKS, NGPTOTG, 1)
    CALL VALIDATE('TENDENCY_LOC%CLD', B_LOC(:,:,:,:), SELF%B_LOC(:,:,:,:), NPROMA, SELF%KLEV, NCLV, NGPTOT, NBLOCKS, NGPTOTG, 4, 3+NCLV)
