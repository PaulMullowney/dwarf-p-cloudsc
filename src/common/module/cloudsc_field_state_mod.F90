...
MODULE CLOUDSC_FIELD_STATE_MOD
  ...
  TYPE CLOUDSC_FIELD_STATE
    ...
    CLASS(FIELD_3RB), POINTER :: F_PLCRIT_AER, F_PICRIT_AER, F_PRE_ICE, F_PCCN, F_PNICE, F_PT, F_PQ, &
    ...
    CLASS(FIELD_3RB), POINTER :: F_PFSQLF, F_PFSQIF, F_PFCQLNG, F_PFCQNNG, F_PFSQRF, F_PFSQSF, F_PFCQRNG, &
...
CONTAINS
  ...
  FUNCTION CREATE_FIELD_ALLOCATE_2D(SHAPE, ZERO) RESULT(FIELD_PTR)
    CLASS(FIELD_2RB), POINTER :: FIELD_PTR
    INTEGER(KIND=JPIM), INTENT(IN) :: SHAPE(2)
    LOGICAL, OPTIONAL, INTENT(IN) :: ZERO
    INTEGER(KIND=JPIM) :: B

    CALL FIELD_NEW(FIELD_PTR, UBOUNDS=SHAPE, PERSISTENT=.TRUE.)
  ...
  FUNCTION CREATE_FIELD_ALLOCATE_3D(SHAPE, ZERO) RESULT(FIELD_PTR)
  ...
  FUNCTION CREATE_FIELD_ALLOCATE_4D(SHAPE, ZERO) RESULT(FIELD_PTR)
...
!      SELF%F_PFHPSN => CREATE_FIELD_WRAP_PACKED_3D(DATA=SELF%DATA_RWONLY, IDX=14)
    ...
    ELSE
      CALL FIELD_NEW(SELF%F_PT, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PQ, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PVFA, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PVFL, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PVFI, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PDYNA, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PDYNL, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PDYNI, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PHRSW, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PHRLW, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PVERVEL, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PAP, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PLU, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PLUDE, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PSNDE, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PMFU, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PMFD, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PA, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PSUPSAT, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PLCRIT_AER, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PICRIT_AER, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PRE_ICE, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PCCN, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      CALL FIELD_NEW(SELF%F_PNICE, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      ...
      CALL FIELD_NEW(SELF%F_PCOVPTOT, UBOUNDS=[NPROMA,SELF%KLEV,SELF%NBLOCKS], PERSISTENT=.TRUE.)
      SELF%F_PRAINFRAC_TOPRFZ => CREATE_FIELD_ALLOCATE_2D(SHAPE=[NPROMA,SELF%NBLOCKS], ZERO=.TRUE.)

      ! Allocate bulk buffers for output 3D fields
      SELF%F_PFSQLF => CREATE_FIELD_ALLOCATE_3D(SHAPE=[NPROMA,SELF%KLEV+1,SELF%NBLOCKS], ZERO=.TRUE.)
      SELF%F_PFSQIF => CREATE_FIELD_ALLOCATE_3D(SHAPE=[NPROMA,SELF%KLEV+1,SELF%NBLOCKS], ZERO=.TRUE.)
      SELF%F_PFCQLNG => CREATE_FIELD_ALLOCATE_3D(SHAPE=[NPROMA,SELF%KLEV+1,SELF%NBLOCKS], ZERO=.TRUE.)
      SELF%F_PFCQNNG => CREATE_FIELD_ALLOCATE_3D(SHAPE=[NPROMA,SELF%KLEV+1,SELF%NBLOCKS], ZERO=.TRUE.)
      SELF%F_PFSQRF => CREATE_FIELD_ALLOCATE_3D(SHAPE=[NPROMA,SELF%KLEV+1,SELF%NBLOCKS], ZERO=.TRUE.)
      SELF%F_PFSQSF => CREATE_FIELD_ALLOCATE_3D(SHAPE=[NPROMA,SELF%KLEV+1,SELF%NBLOCKS], ZERO=.TRUE.)
      SELF%F_PFCQRNG => CREATE_FIELD_ALLOCATE_3D(SHAPE=[NPROMA,SELF%KLEV+1,SELF%NBLOCKS], ZERO=.TRUE.)
      SELF%F_PFCQSNG => CREATE_FIELD_ALLOCATE_3D(SHAPE=[NPROMA,SELF%KLEV+1,SELF%NBLOCKS], ZERO=.TRUE.)
      SELF%F_PFSQLTUR => CREATE_FIELD_ALLOCATE_3D(SHAPE=[NPROMA,SELF%KLEV+1,SELF%NBLOCKS], ZERO=.TRUE.)
      SELF%F_PFSQITUR => CREATE_FIELD_ALLOCATE_3D(SHAPE=[NPROMA,SELF%KLEV+1,SELF%NBLOCKS], ZERO=.TRUE.)
      SELF%F_PFPLSL => CREATE_FIELD_ALLOCATE_3D(SHAPE=[NPROMA,SELF%KLEV+1,SELF%NBLOCKS], ZERO=.TRUE.)
      SELF%F_PFPLSN => CREATE_FIELD_ALLOCATE_3D(SHAPE=[NPROMA,SELF%KLEV+1,SELF%NBLOCKS], ZERO=.TRUE.)
      SELF%F_PFHPSL => CREATE_FIELD_ALLOCATE_3D(SHAPE=[NPROMA,SELF%KLEV+1,SELF%NBLOCKS], ZERO=.TRUE.)
      SELF%F_PFHPSN => CREATE_FIELD_ALLOCATE_3D(SHAPE=[NPROMA,SELF%KLEV+1,SELF%NBLOCKS], ZERO=.TRUE.)
    END IF

    ! TODO: For now we treat all fields as single-allocations
    SELF%TENDENCY_LOC%F_T => CREATE_FIELD_ALLOCATE_3D(SHAPE=[NPROMA,SELF%KLEV,SELF%NBLOCKS], ZERO=.TRUE.)
    SELF%TENDENCY_LOC%F_A => CREATE_FIELD_ALLOCATE_3D(SHAPE=[NPROMA,SELF%KLEV,SELF%NBLOCKS], ZERO=.TRUE.)
    SELF%TENDENCY_LOC%F_Q => CREATE_FIELD_ALLOCATE_3D(SHAPE=[NPROMA,SELF%KLEV,SELF%NBLOCKS], ZERO=.TRUE.)
    SELF%TENDENCY_LOC%F_CLD => CREATE_FIELD_ALLOCATE_4D(SHAPE=[NPROMA,SELF%KLEV,NCLV,SELF%NBLOCKS], ZERO=.TRUE.)
