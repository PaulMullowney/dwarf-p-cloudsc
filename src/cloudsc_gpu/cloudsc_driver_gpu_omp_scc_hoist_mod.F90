...
CONTAINS
  ...
  SUBROUTINE CLOUDSC_DRIVER_GPU_SCC_HOIST( &
    ...
    REAL(KIND=JPRB), ALLOCATABLE :: ZFOEALFA(:,:,:)
    REAL(KIND=JPRB), ALLOCATABLE :: ZTP1(:,:,:)
    REAL(KIND=JPRB), ALLOCATABLE :: ZLI(:,:,:)
    REAL(KIND=JPRB), ALLOCATABLE :: ZA(:,:,:)
    REAL(KIND=JPRB), ALLOCATABLE :: ZAORIG(:,:,:)
    REAL(KIND=JPRB), ALLOCATABLE :: ZLIQFRAC(:,:,:)
    REAL(KIND=JPRB), ALLOCATABLE :: ZICEFRAC(:,:,:)
    REAL(KIND=JPRB), ALLOCATABLE :: ZQX(:,:,:,:)
    REAL(KIND=JPRB), ALLOCATABLE :: ZQX0(:,:,:,:)
    REAL(KIND=JPRB), ALLOCATABLE :: ZPFPLSX(:,:,:,:)
    REAL(KIND=JPRB), ALLOCATABLE :: ZLNEG(:,:,:,:)
    REAL(KIND=JPRB), ALLOCATABLE :: ZQXN2D(:,:,:,:)
    REAL(KIND=JPRB), ALLOCATABLE :: ZQSMIX(:,:,:)
    REAL(KIND=JPRB), ALLOCATABLE :: ZQSLIQ(:,:,:)
    REAL(KIND=JPRB), ALLOCATABLE :: ZQSICE(:,:,:)
    REAL(KIND=JPRB), ALLOCATABLE :: ZFOEEWMT(:,:,:)
    REAL(KIND=JPRB), ALLOCATABLE :: ZFOEEW(:,:,:)
    REAL(KIND=JPRB), ALLOCATABLE :: ZFOEELIQT(:,:,:)
...
!$omp target data &
!$omp map(alloc: ZFOEALFA, ZTP1, ZLI, ZA, ZAORIG, ZLIQFRAC, ZICEFRAC, ZQX, ZQX0,  &
