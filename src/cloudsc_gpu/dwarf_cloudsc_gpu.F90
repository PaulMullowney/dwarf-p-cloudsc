...
#ifdef CLOUDSC_GPU_OMP_SCC_RAW_STACK
USE CLOUDSC_DRIVER_GPU_OMP_SCC_RAW_STACK_MOD, ONLY: CLOUDSC_DRIVER_GPU_SCC_RAW_STACK
#endif
...
#if defined(CLOUDSC_GPU_OMP_SCC_RAW_STACK)
print '(1X,A42)', 'Executing CLOUDSC-GPU, "SCC-RAW-STACK" variant...'

 ! Call the driver to perform the parallel loop over our kernel
CALL CLOUDSC_DRIVER_GPU_SCC_RAW_STACK(NUMOMP, NPROMA, GLOBAL_STATE%KLEV, NGPTOT, NGPTOTG, GLOBAL_STATE%NBLOCKS, &
     & GLOBAL_STATE%KFLDX, GLOBAL_STATE%PTSPHY, &
     & GLOBAL_STATE%PT, GLOBAL_STATE%PQ, &
     & GLOBAL_STATE%TENDENCY_CML, GLOBAL_STATE%TENDENCY_TMP, GLOBAL_STATE%TENDENCY_LOC, &
     & GLOBAL_STATE%B_CML,   GLOBAL_STATE%B_TMP, GLOBAL_STATE%B_LOC, &
